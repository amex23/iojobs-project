...
export default function Create() {
    ...
    return (
        <div className="px-4 lg:px-12 py-12 max-w-2xl mx-auto lg:max-w-7xl lg:h-auto flex flex-col justify-between gap-8">
            <RecruiterHeader></RecruiterHeader>
             <div className='flex flex-col gap-y-5'>
                <Link href={route('recruiter.dashboard')} className="text-sm text-gray-500 underline">
                            ← Back to Dashboard
                </Link>
                <div className="mb-10 lg:mb-0 bg-white px-3 lg:px-8 py-12 w-full flex justify-center mx-auto flex-col items-center shadow-md rounded-sm">
