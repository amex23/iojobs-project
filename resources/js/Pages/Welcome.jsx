                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div className="hidden lg:flex flex-row items-start justify-between w-full gap-4 mt-4">
                                        ...
                                        <div className="flex flex-col items-center gap-2 w-1/3">
                                            <div className="flex justify-center w-full">
                                                <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#474747]/10 sm:size-16">
                                                <svg className="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#141413">
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 flex-col lg:flex-row">
                                    ...
                                    <a href="" className='self-center lg:self-start lg:mt-5 w-auto lg:w-[25%] flex bg-[#141413] justify-center items-center py-2 text-white font-bold gap-2 px-2 rounded-md'>
