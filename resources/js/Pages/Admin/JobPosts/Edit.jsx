...
export default function Edit({ job }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('admin.jobs.update', job.id));
    };

    return (
        <div className="p-8 max-w-2xl mx-auto">
            <h1 className="text-2xl font-bold mb-6">Edit Job Post (Admin)</h1>
            ...
            <form onSubmit={submit} className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2">
                    <Link href={route('admin.jobs.index')} className="text-sm text-gray-500 underline">
                        Cancel
                    </Link>
